...
const Dashboard = () => {
  ...
  // fetch agriculture news alerts through the backend
  useEffect(() => {
  ...
  // Randomly select 3 schemes from combined central and state schemes
  useEffect(() => {
    const loadSchemes = async () => {
      try {
        ...
        const allSchemes = data.government_schemes.flatMap(
          (item) => item.schemes
        );
          ...
          <div className="right-sidebar">
              ...
              {alerts.length === 0 ? (
                ...
                <div style={{ fontSize: "0.85rem", color: "#333" }}>
                  ...
                  >
                    ...
                    {new Date(
                      alerts[currentNewsIndex].pubDate
                    ).toLocaleDateString()}
                  </div>
                </div>
              )}
            ...
            <div className="card tall">
              {schemes[0] ? (
                ...
                >
                  📜{" "}
                  {schemes[0].name.length > 75
                    ? schemes[0].name.slice(0, 75) + "..."
                    : schemes[0].name}
                </a>
              ) : (
            ...
            <div className="card tall">
              {schemes[1] ? (
                ...
                >
                  📜{" "}
                  {schemes[1].name.length > 75
                    ? schemes[1].name.slice(0, 75) + "..."
                    : schemes[1].name}
                </a>
              ) : (
            ...
            <div className="card tall">
              {schemes[2] ? (
                ...
                >
                  📜{" "}
                  {schemes[2].name.length > 75
                    ? schemes[2].name.slice(0, 75) + "..."
                    : schemes[2].name}
                </a>
              ) : (
